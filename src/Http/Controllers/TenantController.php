...
use Rutatiina\PaymentsMade\Models\PaymentsMade;
use Rutatiina\PaymentsMade\Models\PaymentsMadeItem;
use Rutatiina\PaymentsMade\Models\PaymentsMadeItemTax;
use Rutatiina\PaymentsMade\Models\PaymentsMadeLedger;
...
//
    public function deleteTxns($id)
    {
        ...
        BillRecurring::query()->forceDelete();
        BillRecurringItem::query()->forceDelete();
        BillRecurringItemTax::query()->forceDelete();
        ...
        ExpenseRecurring::query()->forceDelete();
        ExpenseRecurringItem::query()->forceDelete();
        ExpenseRecurringItemTax::query()->forceDelete();
        ExpenseRecurringLedger::query()->forceDelete();
        ...
        InvoiceRecurring::query()->forceDelete();
        InvoiceRecurringItem::query()->forceDelete();
        InvoiceRecurringItemTax::query()->forceDelete();
        InvoiceRecurringLedger::query()->forceDelete();

        PaymentsMade::query()->forceDelete();
        PaymentsMadeItem::query()->forceDelete();
        PaymentsMadeItemTax::query()->forceDelete();
        PaymentsMadeLedger::query()->forceDelete();
        ...
        ReceiptItem::query()->forceDelete();
        ReceiptItemTax::query()->forceDelete();
        ReceiptLedger::query()->forceDelete();
